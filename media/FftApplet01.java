...
//
// Copied from http://sepwww.stanford.edu/oldsep/hale/FftLab.html
// I made a few minor changes to force it to fit in a space 400 pixels wide.
// Dick Baldwin
/////////////////////////////////////////////////////////////////////////////
...
public class FftApplet01 extends java.applet.Applet {
    MainPanel mainPanel;
    ControlPanel controlPanel;
    public void init() {
        FftApplet01Controller controller = new FftApplet01Controller();
    ...
    public static void main(String args[]) {
        ...
        FftApplet01 FftApplet01 = new FftApplet01();
        FftApplet01.init();
        FftApplet01.start();
        frame.add("Center",FftApplet01);
...
/////////////////////////////////////////////////////////////////////////////
// Main panel for FftApplet01 contains samples views.
...
/////////////////////////////////////////////////////////////////////////////
// Control panel for FftApplet01.

class ControlPanel extends Panel {

    public ControlPanel(FftApplet01Controller c) {
        this.c = c;
        add(new Checkbox("Orig Cntr"));
        length = new LabeledChoice("Len:");
        length.choice.addItem("16");
        length.choice.addItem("32");
        length.choice.addItem("64");
        length.choice.select("32");
        add(length);
        mode = new LabeledChoice("Edit:");
    ...
    private FftApplet01Controller c;
